            ...
            for section in sections:
                ...
                if (flag_number is not None and matched_criteria and 
                    ...
                    if flag_number is not None:
                        logger.info(f"Debug: Incomplete parsing for FLAG_{flag_number} in {bucket_name}")
...
def process_pdf_enhanced_pipeline_with_split_iteration(pdf_path: str, folder_name: str, previous_year_data: str, 
    ...
    try:
       ...
       # ITERATION 2: Enhanced Deduplication - Modified for direct client approach
        logger.info("Running 2nd iteration - Enhanced Deduplication...")
...
Provide factual category summaries:"""
        ...
        logger.info(f"High Risk Flags: {risk_counts['High']}")
        logger.info(f"Low Risk Flags: {risk_counts['Low']}")
        logger.info(f"Total Flags: {risk_counts['Total']}")
