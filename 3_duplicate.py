...
2. If it matches, classify as "High" or "Low" based on the criterion
...
def process_pdf_simple_pipeline(pdf_path: str, queries_csv_path: str, previous_year_data: str, 
    ...
    """
    Process PDF through simplified 5-iteration pipeline
    """
...
def main():
    ...
    api_key = "8496bd161e498c"
    azure_endpoint = "https://crisizure.com"
    api_version = "2025-01-01-preview"
    deployment_name = "gptmini"
