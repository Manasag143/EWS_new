...
Provide factual category summaries:"""
        ...
        try:
            flags_with_context = extract_flags_with_complete_context(first_response)
...
def main(): 
    ...
    PATHS_CONFIG = {
        ...
        "output_folder": r"kalyan_results_split_iteration_3"
    }
...
Cash balance as per previous reported balance sheet number	975Cr
