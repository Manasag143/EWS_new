...
def create_criteria_buckets():
    ...
    bucket_1 = [    
        ...
        """debt_ebitda: 
            High: Debt/EBITDA > 3x i.e. Debt to EBITDA ratio is above/upwards (greater than) three times; 
...
def main(): 
    ...
    PATHS_CONFIG = {
        "pdf_folder_path": r"sterlite_march",
        "queries_csv_path": r"EWS_prompts_v2_2.xlsx",
        "output_folder": r"sterlite_march_results_split_iteration_3"
    }
    
    PREVIOUS_YEAR_DATA = """
Debt as per Previous reported balance sheet number	3376Cr
Current quarter ebidta	209Cr
Asset value as per previous reported balance sheet number	8278Cr
Receivable days as per previous reported balance sheet number	143days
Payable days as per Previous reported balance sheet number	472days
Revenue as per previous reported quarter number	843Cr
profit before tax as per previous reported quarter number	-105Cr
profit after tax as per previous reported quarter number	-82Cr
EBIDTA as per previous reported quarter number	53Cr
Operating margin as per previous quarter number	12%	
Cash balance as per previous reported balance sheet number	403Cr
Short term borrowings as per the previous reported balance sheet number	2234Cr
previous reported net worth from balance sheet	1653Cr
Receivables as per previous reported balance sheet number	1621Cr
Payables as per Previous reported balance sheet number	2178Cr
"""
...
High
Debt is increased for the company or any business line of the company more than 30% compared to previous reported balance sheet number
Debt/EBITDA > 3x i.e. Debt to EBITDA ratio is above (greater than) three times for the company or any business line of the company
Short-term borrowings or current liabilities increase by more than 30% compared to previous reported balance sheet number for the company or any business line of the company
cash balance for the company or any business line of the company falling more than 25% compared to previous reported balance sheet number
revenue falls for the company or any business line of the company by more than 25% compared to previous reported quarter number
profitability or profit before tax (PBT) falls by more than 25% compared to previous reported quarter number for the company or any business line of the company
Profit after tax (PAT) falls by more than 25% compared to previous reported quarter number for the company or any business line of the company
EBITDA falls by more than 25% compared to previous reported quarter number for the company or any business line of the company
operating margin falling more than 25% compared to previous reported quarter number for the company or any business line of the company
gross margin falling more than 100 bps (basis points) i.e. if the gross margin is falling by more than 1 %
one-time expenses or losses more than 25% of current quarter's EBITDA for the company or any business line of the company
provisioning or write-offs more than 25% of current quarter's EBITDA for the company or any business line of the company
receivable days OR debtor days for the company or any business line of the company are increased more than 30% compared to previous reported balance sheet number
payable days or creditors days for the company or any business line of the company increase by more than 30% compared to previous reported balance sheet number
receivables or debtors for the company or any business line of the company are increased more than 30% compared to previous reported balance sheet number
payables or creditors for the company or any business line of the company increase by more than 30% compared to previous reported balance sheet number
Asset value for the company or any business line of the company falls by more than 30% compared to the previous reported balance sheet number
Impairment or devaluation more than 25% of previous reported net worth from balance sheet for the company or any business line of the company
If found any management or strategy related issues or concerns or a conclusion of any discussion related to management and strategy
if found any regulatory issues as a concern or a conclusion of any discussion related to regulatory issues or warning(s) from the regulators and if there is any mention of delays in obtaining necessary permits, approvals, licenses
Any signs of competitive intensity, new entrants, pricing pressure (including dumping or price changes), or decline in market share
if found any operational or supply chain issues as a concern or a conclusion of any discussion related to operational issues
If there are any other material issues with quantified impact more than 25% of current quarter EBITDA
"If there is a mention of: “Significant decline” in key metrics such as revenue, EBITDA, profit (PAT/PBT), margins, or other metrics, even if the quantum is not provided
or if there is any mentions of “high erosion of net worth,” with or without mention of quantum. or References to “massive losses,” with or without mention of quantum."
If there is number comparison provided in transcript which is beyond severity logic, and if decline / moderation is more than 25%
If there is increase in amount for ‘Receivables-due for more than one year or 6 months
If transcript mentions indemnity assets, such as "indemnity claims" or "indemnity receivable" more than 25% of net worth
Calculate the ratio of debt servicing to net cash accrual and provide a high-risk flag if the calculated ratio is greater than 1.5
...
low 
Debt increased less than 30% compared to previous reported balance sheet number
Debt/EBITDA < 3x i.e. Debt to EBITDA ratio is less than three times
Short-term borrowings or current liabilities increase is less than 30% compared to previous reported balance sheet number
cash balance falling less than 25% compared to previous reported balance sheet number
revenue falls by less than 25% compared to previous reported quarter number
profitability or profit before tax (PBT) falls by less than 25% compared to previous reported quarter number
Profit after tax (PAT) falls by less than 25% compared to previous reported quarter number
EBITDA falls by less than 25% compared to previous reported quarter number
Operating margin falling less than 25% compared to previous reported quarter number
gross margin falling by less than 100 bps (basis points) i.e.1% for the company or any business line of the company
one-time expenses or losses less than 25% of current quarter's EBITDA
provisioning or write-offs less than 25% of current quarter's EBITDA
receivable days or debtor's days are increased but less than 30% compared to previous reported balance sheet number
payable days or creditors days increase is less than 30% compared to previous reported balance sheet number
receivables or debtors are increase is less than 30% compared to previous reported balance sheet number
payables or creditors is less than 30% compared to previous reported balance sheet number
Asset value falls by less than 30% compared to previous reported balance sheet number
Impairment or devaluation less than 25% of previous reported net worth from balance sheet
If found no issues related to management or strategy or no concerns or a conclusion of any discussion related to management and strategy
if there is a no clear concern for the company basis the discussion on the regulatory issues
Low competitive intensity or no new entrants, or no decline in market share
if there is no clear concern for the company basis the discussion on the operational or supply chain issues
If there are no other material issues with quantified impact more than 25% of current quarter EBITDA
