...
6. Important: If a single flag matches multiple criteria, create separate output sections for each matching criterion. Do not combine them.
...
def main(): 
    ...
    PATHS_CONFIG = {
        ...
        "output_folder": r"sterlin_dec_results_split_iteration_6"
    }
...
# Usage
high_risk_flags = [
"""•	Gross margin declined by 160 basis points (1.6%) from the historical 13–13.5%, exceeding the 1% threshold for high risk.
•	One-time and ongoing write-offs totaling INR 120 crores (INR 70 crores in Q2, INR 50 crores in Q3) represent over 90% of quarterly PAT (INR 130 crores), far above the 25% high risk threshold.
•	Inventory adjustment/write-off of INR 120 crores (INR 70 crores in Q2, INR 50 crores in Q3) exceeds 90% of quarterly PAT (INR 130 crores), indicating severe financial impact.
•	Repeated delays and operational challenges in U.S., Middle East, and South India expansions highlight significant execution and strategic risk at the consolidated level.
•	Consolidated PAT declined 3% YoY and India PAT declined 4% YoY, with management citing ongoing margin pressure and gross margin compression of 160 bps, reflecting inability to maintain profitability.
•	Recurring write-offs of INR 70 crores in Q2 and INR 50 crores expected in Q3 indicate management's failure to anticipate regulatory/inventory risks, materially impacting earnings.
•	Write-offs totaling INR 120 crores are directly linked to regulatory changes (customs duty), highlighting significant regulatory compliance risk.
•	Operational constraints in South and international markets due to low margins, poor traction, and delayed Candere rollout indicate persistent strategic and operational weaknesses.
•	Management revised guidance and deferred segment expansion due to ongoing Candere issues and unplanned write-offs, reflecting a reactive and high-risk strategic posture.
•	Increased debt to fund inventory build-up for international expansion signals aggressive risk-taking and potential overextension, posing strategic risk.
•	Conversion of non-South company-owned outlets to franchise/other models indicates structural and strategic challenges in underperforming markets.
•	Increased branding and promotional activity by local competitors is expected to cause pricing pressure and threaten margins and market share.
•	Ongoing inventory adjustments and write-offs totaling INR 120 crores due to regulatory changes reflect management's inability to manage inventory risk, impacting earnings quality.
•	Inventory write-offs of INR 120 crores are directly tied to regulatory changes in gold duties, resulting in material losses and regulatory risk.
•	Persistent operational disruptions in U.S., Middle East, and South India expansions, including explicit delays and poor traction, materially affect execution timelines.
•	Consolidated PAT declined 3% and India PAT declined 4% YoY, with explicit margin pressure and EBITDA margin compression, indicating severe financial deterioration.
•	One-time write-off of INR 70 crores for 16s duty and an additional INR 50 crores expected next quarter total over INR 120 crores in impairment, materially impacting profitability.
•	Operational constraints in South and international markets, along with delayed Candere marketing, are materially affecting execution and scaling.
•	Additional unplanned write-offs of INR 50 crores expected next quarter and deferred expansion signal material financial stress and impact on profitability.
•	Significant inventory build-up and increased debt for international expansion, particularly in the U.S., indicate operational and financial execution challenges.
•	Conversion of non-South company-owned outlets to franchise/other models due to performance issues signals operational disruptions and structural adjustments.
•	Consolidated PAT declined 3% and India PAT declined 4% YoY, with only marginal PBT growth and EBITDA margin compression, reflecting significant financial deterioration.
•	Interest cost increased from INR 780 million to INR 900 million (over 15% QoQ) and higher depreciation, indicating inefficient capital structure and material financial stress.
•	Soft demand, underwhelming festive sales, and below-target footfalls, especially in Candere, highlight operational challenges impacting business performance.
•	Slow traction and underperformance in South India and Middle East, with underutilized capacity and delayed collateral release, indicate material operational disruptions.
•	Material inventory valuation adjustments and destocking linked to regulatory changes, with further impacts expected, highlight significant financial stress and short-term earnings risk.
"""
]
