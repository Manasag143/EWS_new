...
Relevant Financials: extract all the relevant financial metrics if high risk is identified else NA
...
def generate_strict_high_risk_summary(classification_results: List[Dict[str, str]], llm: AzureOpenAILLM) -> List[str]:
    """
...
def create_word_document(pdf_name: str, company_info: str, risk_counts: Dict[str, int],
    ...
    try:
        ...
        if high_risk_classifications and len(high_risk_classifications) > 0:
            ...
            concise_summaries = generate_strict_high_risk_summary(classification_results, llm)
