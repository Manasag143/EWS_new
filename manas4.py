...
def create_criteria_buckets():
    ...
    bucket_7_qual = [
        ...
        """regulatory_compliance: 
            High: If found any regulatory issues as a concern or a conclusion of any discussion related to regulatory issues or warning(s) from the regulators or if there is any mention of delays in obtaining necessary permits, approvals, licenses; 
...
def main(): 
    ...
    PATHS_CONFIG = {
        ...
        "output_folder": r"vedanta_results_split_iteration_4"
    }
    
    PREVIOUS_YEAR_DATA = """
Debt as per Previous reported balance sheet number	80329Cr
Current quarter ebidta	11511Cr
Asset value as per previous reported balance sheet number	189455Cr
Receivable days as per previous reported balance sheet number	10days
Payable days as per Previous reported balance sheet number	91days
Revenue as per previous reported quarter number	35541Cr
profit before tax as per previous reported quarter number	4105Cr
profit after tax as per previous reported quarter number	2868Cr
EBIDTA as per previous reported quarter number	8531Cr
Operating margin as per previous quarter number	25%
Cash balance as per previous reported balance sheet number	9254Cr
Short term borrowings as per the previous reported balance sheet number	36407Cr
previous reported net worth from balance sheet	47896Cr
Receivables as per previous reported balance sheet number	6414Cr
Payables as per Previous reported balance sheet number	11043Cr
previous quarter net cash accrual(NCA) 	7656Cr
...
modified definition 
If found any management or strategy related issues or concerns in a question or a conclusion of any discussion. This can include any delays, failures, dysfunction, instability etc. due to management / strategy / governance.
If found any regulatory issues as a concern or a conclusion of any discussion. This includes warnings from regulators, delays in obtaining permits, approvals, licenses, or clearances, and any regulatory challenges affecting operations, transactions, or strategic initiatives.
Identify any signs of competitive intensity, new entrants, pricing pressure (including dumping or price changes), or decline in market share. Also include indirect competitive risks such as supply-side constraints, delays, or resource shortages that impact market performance. Additionally, capture macroeconomic factors—such as adverse currency movements, inflation, or trade barriers—that materially affect the company’s competitive position or pricing power.
Identify any operational challenges or supply chain issues mentioned as a concern or conclusion. This includes disruptions due to labor shortages, productivity losses, client-side delays, weather-related impacts, or any other factors that materially affect execution, delivery timelines
Identify any mention of severe financial deterioration using strong adjectives. This includes phrases such as “significant decline” in key metrics (revenue, EBITDA, PAT/PBT, margins), “high erosion of net worth,” “massive losses,” or similar expressions that imply material financial stress. Include such mentions even if the exact quantum is not provided. Also capture other high-impact adjectives like “sharp drop,” “steep fall,” “substantial deterioration,” “severe contraction,” or “critical pressure” when used in the context of financial performance.
...
The sale of the steel plant is delayed pending regulatory clearances expected by Q1 FY '25, with lender NOCs for the vertical split also pending but anticipated by end of April or early May
